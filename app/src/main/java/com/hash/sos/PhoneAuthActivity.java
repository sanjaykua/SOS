...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    public void onStart() {
        ...
        if(currentUser != null){
            FirebaseDatabase.getInstance().getReference().child("user").child(currentUser.getUid()).addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (user != null) {
                        ...
                        startActivity(new Intent(PhoneAuthActivity.this, profile_detail.class));
                        finish();
                    }
                }
